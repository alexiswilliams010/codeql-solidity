...
private import codeql.Cfg
private import codeql.solidity.ast.internal.Ast as Ast
...
private module JoinBlockPredecessors {
  private predicate id(Solidity::AstNode x, Solidity::AstNode y) { x = y }

  private predicate idOf(Solidity::AstNode x, int y) = equivalenceRelation(id/2)(x, y)
