...
module Solidity {
  ...
  private @file getNodeFile(@solidity_ast_node node) {
    exists(@location_default loc | solidity_ast_node_location(node, loc) |
      locations_default(loc, result, _, _, _, _)
    )
  }

  /** Holds if `node` is in the `file` and is part of the overlay base database. */
  private predicate discardableAstNode(@file file, @solidity_ast_node node) {
  ...
  overlay[discard_entity]
  private predicate discardAstNode(@solidity_ast_node node) {
    exists(@file file, string path | files(file, path) |
  ...
  class ContractDeclaration extends @solidity_contract_declaration, AstNode {
    ...
    /** Gets the `i`th child of this node. */
    final AstNode getChild(int i) { solidity_contract_declaration_child(this, i, result) }
  ...
  class ForStatement extends @solidity_for_statement, AstNode {
    ...
    /** Gets the node corresponding to the field `condition`. */
    final AstNode getCondition() { solidity_for_statement_def(this, _, result, _) }
  ...
  /** A class representing `layout_specifier` nodes. */
  class LayoutSpecifier extends @solidity_layout_specifier, AstNode {
    /** Gets the name of the primary QL class for this element. */
    final override string getAPrimaryQlClass() { result = "LayoutSpecifier" }

    /** Gets the child of this node. */
    final Expression getChild() { solidity_layout_specifier_def(this, result) }

    /** Gets a field or child node of this node. */
    final override AstNode getAFieldOrChild() { solidity_layout_specifier_def(this, result) }
  }
  ...
  /** A class representing `state_location` tokens. */
  class StateLocation extends @solidity_token_state_location, Token {
    /** Gets the name of the primary QL class for this element. */
    final override string getAPrimaryQlClass() { result = "StateLocation" }
  }
  ...
  class StateVariableDeclaration extends @solidity_state_variable_declaration, AstNode {
    ...
    /** Gets the node corresponding to the field `location`. */
    final StateLocation getLocation(int i) {
      solidity_state_variable_declaration_location(this, i, result)
    }
    ...
    /** Gets a field or child node of this node. */
    final override AstNode getAFieldOrChild() {
      solidity_state_variable_declaration_location(this, _, result) or
  ...
  /** A class representing `user_definable_operator` tokens. */
  class UserDefinableOperator extends @solidity_token_user_definable_operator, Token {
    /** Gets the name of the primary QL class for this element. */
    final override string getAPrimaryQlClass() { result = "UserDefinableOperator" }
  }
  ...
  /** A class representing `using_alias` nodes. */
  class UsingAlias extends @solidity_using_alias, AstNode {
    /** Gets the name of the primary QL class for this element. */
    final override string getAPrimaryQlClass() { result = "UsingAlias" }

    /** Gets the `i`th child of this node. */
    final AstNode getChild(int i) { solidity_using_alias_child(this, i, result) }

    /** Gets a field or child node of this node. */
    final override AstNode getAFieldOrChild() { solidity_using_alias_child(this, _, result) }
  }
  ...
  class UsingDirective extends @solidity_using_directive, AstNode {
    ...
    /** Gets the node corresponding to the field `source`. */
    final AstNode getSource() { solidity_using_directive_def(this, result) }

    /** Gets the `i`th child of this node. */
    final AstNode getChild(int i) { solidity_using_directive_child(this, i, result) }

    /** Gets a field or child node of this node. */
    final override AstNode getAFieldOrChild() {
      solidity_using_directive_def(this, result) or solidity_using_directive_child(this, _, result)
    }
  }
  ...
  /** A class representing `yul_hex_string_literal` tokens. */
  class YulHexStringLiteral extends @solidity_token_yul_hex_string_literal, Token {
    /** Gets the name of the primary QL class for this element. */
    final override string getAPrimaryQlClass() { result = "YulHexStringLiteral" }
  }
